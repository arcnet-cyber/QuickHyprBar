...
local menu        = "qs -p ~/.config/quickshell/applaunch/AppLauncher.qml"
...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("qs -p ~/.config/quickshell/barshell/bar.qml")
  hl.exec_cmd("hyprpaper")
end)
  hl.exec_cmd("./.config/ShellScripts/check-update.sh") 
...
-- See https://wiki.hypr.land/Configuring/Layouts/Scrolling-Layout/ for morehl.config({
--hl.config({
--  scrolling = {
...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd(internet))

--Toggle Floating
hl.bind(mainMod .. " + H", hl.dsp.window.float({ action = "toggle" }))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + X", hl.dsp.layout("swapwithmaster")) --master only
...
-- Screenshot and copy to clipboard screenshot
hl.bind("Print", hl.dsp.exec_cmd('grim ~/Desktop/$(date +%Y-%m-%d_%H-%M-%S).png'))
